...
describe('UserService', () => {
  ...
  describe('create', () => {
    it('should create a new user and return it', async () => {
      ...
      const hashRounds = 10;
      const hashedpassword = 'hashsshahshd';
      const result = {
        id: 1,
    ...
    it('should throw a BadRequestException if email alreadt exists', () => {
      const createUserDto: CreateUserDto = {
        email: 'test@codefactory.ai',
        password: '123123',
      };
  ...
  describe('update', () => {
    it('should update a user if it exists and return the ipdated user', async () => {
  ...
  describe('remove', () => {
    it('shold delete a user by id', async () => {
      const id = 999;
