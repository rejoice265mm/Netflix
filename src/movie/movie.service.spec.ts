...
describe('MovieService', () => {
  ...
  describe('findRecent', () => {
    it('should return recent movies from cache', async () => {
      const cacheMovies = [{ id: 1, title: 'Movie 1' }];
    ...
    it('should fetch recent mocies from the repository and cache them if not found in cache', async () => {
  ...
  describe('findOne', () => {
    ...
    it('should thorw NotFoundException if moive is not found', async () => {
  ...
  describe('create', () => {
    ...
    it('should create a movie successfully', async () => {
      ...
      const movieDetailInsertResilt = { identifiers: [{ id: 1 }] };
      const movieInsertResilt = { identifiers: [{ id: 1 }] };
      ...
      createMovieDetailMock.mockResolvedValue(movieDetailInsertResilt);
      createMovieMock.mockResolvedValue(movieInsertResilt);
      ...
      expect(createMovieMock).toHaveBeenCalledWith(
        ...
        createMovieDto,
        director,
        movieDetailInsertResilt.identifiers[0].id,
        userId,
        expect.any(String),
      );
      expect(createMovieGenreRelationMock).toHaveBeenCalledWith(
        qr,
        movieInsertResilt.identifiers[0].id,
        genres,
      );
  ...
  describe('update', () => {
    ...
    it('should update a movie suuccessfully', async () => {
    ...
    it('should throw NotFoundExecption if movie does not exist', async () => {
      const updateMovieDto: UpdateMovieDto = {
        title: 'Updated Movie',
      };
  ...
  describe('toggleMovieLike', () => {
    ...
    let getLikeRecordMock: jest.SpyInstance;
    ...
    beforeEach(() => {
      ...
      getLikeRecordMock = jest.spyOn(movieService, 'getLikeRecord');
    ...
    it('should toggle movie like status succesfully when like record exists and isLike is different', async () => {
      ...
      expect(getLikeRecordMock).toHaveBeenCalledWith(1, 1);
    ...
    it('should save a new like record when no existion record is found', async () => {
      const movie = { id: 1 };
      const user = { id: 1 };
