...
const mockUserRepository = { findOne: jest.fn(), set: jest.fn() };
...
const mockCacheManager = { set: jest.fn() };
...
describe('AuthService', () => {
  ...
  describe('tokenBlock', () => {
    it('should block a token', async () => {
      ...
      await authService.tokenBolck(token);
  ...
  describe('parseBearerToken', () => {
    it('should parse a vlid Bearer Toekn', async () => {
    ...
    it('should throw a UnauthorizedException if payload.type is not refresh but isRefreshToken paramet', () => {
  ...
  describe('authenticate', () => {
    ...
    it('should throw an error for not existion user', async () => {
  ...
  describe('login', () => {
    it('shoule login a user and return tokens', async () => {
